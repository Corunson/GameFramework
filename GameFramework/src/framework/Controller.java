...
public abstract class Controller implements KeyListener, WindowListener, MouseListener, ActionListener {
	...
	private final List<Model> entityList = Collections.synchronizedList(new ArrayList<Model>());
	...
	protected final void removeEntity(Model model) {
